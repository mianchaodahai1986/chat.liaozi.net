...
<%@ page language="java" import="com.easemob.lmc.service.TalkDataService" %>
<%@ page language="java" import="com.easemob.lmc.model.TalkNode" %>
<%@ page language="java" import="com.easemob.lmc.model.Authentic" %>
<%@ page language="java" import="com.easemob.lmc.service.TalkDataService" %>
<%@ page language="java" import="com.easemob.lmc.service.impl.TalkDataServiceImpl" %>
<%@ page language="java" import="com.easemob.lmc.service.impl.TalkHttpServiceImplApache" %>
<%@ page language="java" import="com.easemob.lmc.tool.JsonTool" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
<title>Insert title here</title>
<script src="sdk/src/connection.js"></script>
<script src="sdk/src/message.js"></script>
<script src="sdk/src/queue.js"></script>
<script src="sdk/src/status.js"></script>
<script src="sdk/src/utils.js"></script>
...
<%
	...
	Test test = new Test();
	talkNode = service.friendList("admin");
%>
<table border="1" width="800">
<tr><td><%=application.getAttribute("app_fy") %>
</table>

<form action="" method = "get" name = "chats">
