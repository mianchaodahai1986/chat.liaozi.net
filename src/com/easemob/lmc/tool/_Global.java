...
public class _Global {
	...
	public static String APP_KEY = "1134170803178856#mianchaodahai";
	public static String APP_CLIENT_ID = "YXA6TdPn0Hf3EeeZ3ZXcMtv6JA";
	public static String APP_CLIENT_SECRET = "YXA6Qfwm1qQ-nfr4kLvztqyDYFdz9C0";
	//TODO 以上参数需相应修改
